      ...
      <div className="grid grid-cols-1 lg:grid-cols-[320px_minmax(0,1fr)_320px] gap-6 divide-y lg:divide-y-0 lg:divide-x divide-gray-200">
        ...
        <div className="pt-4 lg:pt-0 lg:pr-6 flex flex-col gap-6">
          <article>
            ...
            <h3 className="text-xl font-bold leading-tight hover:text-[#ce1126] cursor-pointer mb-2">
          ...
          <article>
            ...
            <h3 className="text-lg font-bold leading-tight hover:text-[#ce1126] cursor-pointer mb-2">
        ...
        <div className="pt-4 lg:pt-0 lg:pl-6 flex flex-col gap-6">
          ...
          <article>
            ...
            <h3 className="text-md font-bold leading-tight hover:text-[#ce1126] cursor-pointer mb-2">
