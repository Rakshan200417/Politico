  ...
  const electionsSubStories = [
    {
      ...
      title: "Republicans are breaking with Donald Trump on data centers",
      byline: "BY LISA KASHINSKY",
    },
    {
      id: "2",
      image:
        "https://images.unsplash.com/photo-1529156069898-49953e39b3ac?auto=format&fit=crop&w=600&q=80",
      title: "Tom Kean Jr.'s campaign playbook appears to be backfiring",
      byline: "BY MATT FRIEDMAN",
    },
    {
      id: "3",
      image:
      ...
      title:
        "How Democrats eyeing 2028 won and lost in primaries they endorsed in",
      byline:
        "BY JESSICA PIPER, LISA KASHINSKY, AARON PELLISH AND ERIN DOHERTY",
    },
  ];
  ...
  return (
    <section className="w-full font-sans my-8">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 divide-y lg:divide-y-0 lg:divide-x divide-gray-200 items-start">
        ...
        {/* Left Column (3 cols): Empty spacer — keeps alignment with other sections */}
        <div className="hidden lg:block lg:col-span-3 pr-3" />

        {/* Middle Column (6 cols): ELECTIONS Main Section */}
        <div className="lg:col-span-6 space-y-6 pt-6 lg:pt-0 lg:px-4">
          ...
          <article className="group cursor-pointer">
            <a href={`/news/${slugify("Mike Johnson planning to meet with Elon Musk in Texas")}`} className="block space-y-3" target="_blank">
              <div className="aspect-[16/9] bg-gray-100 overflow-hidden relative">
                <img
                  src="https://images.unsplash.com/photo-1540910419892-4a36d2c3266c?auto=format&fit=crop&w=1000&q=80"
                  alt="Mike Johnson meeting with Elon Musk"
