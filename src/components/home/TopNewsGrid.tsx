    ...
    <div className="w-full font-sans">
      ...
      <div className="flex flex-col gap-4">
        ...
        <article className="group cursor-pointer">
          <a href={`/news/${slugify(story1)}`} className="block" target="_blank">
        ...
        <article className="group cursor-pointer border-t border-[#e3e3e3] pt-4 mb-2">
          <a href={`/news/${slugify(story2)}`} className="block" target="_blank">
        ...
        <div className="grid grid-cols-2 gap-4 border-t border-[#e3e3e3] pt-4">
          <article className="group cursor-pointer">
            <a href={`/news/${slugify(story3)}`} className="block space-y-2" target="_blank">
          ...
          <article className="group cursor-pointer">
            <a href={`/news/${slugify(story4)}`} className="block space-y-2" target="_blank">
              <div className="aspect-[16/10] overflow-hidden bg-gray-100">
                <img
