    ...
    <div className="min-h-screen flex flex-col font-sans bg-gray-50">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-8 lg:p-12">
        <div className="bg-white rounded-lg shadow-sm p-10 border border-gray-200 text-center mt-10">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Reader Dashboard</h1>
          <p className="text-gray-600 mb-8">
            Welcome to the Reader workspace. Your personalized news feed, saved articles, and subscriptions will be available here soon.
          </p>
